...
dotnet publish %SRCDIR%OwinRequestScopeContext/OwinRequestScopeContext.csproj --framework net461 --configuration Release --verbosity detailed --output "bin/Publish/net461" /p:IsPublishing="true"
pause
